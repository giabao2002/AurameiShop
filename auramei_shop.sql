...
(465, 1, 'Hoàng Văn A', '0123456789', 'Thanh Xuân, Hà Nội', 'Đơn hàng mua trực tiếp'),
(629, 3, 'Nguyễn Văn Cảnh', '0987654321', 'Quốc Oai, Hà Nội', ''),
(1393, 3, 'Nguyễn Văn Cảnh', '0987654321', 'Thanh Xuân, Hà Nội', ''),
(1914, 3, 'Nguyễn Văn Cảnh', '0987654321', 'Quốc Oai, Hà Nội', 'Giao hàng nhanh'),
(2693, 3, 'Nguyễn Văn Cảnh', '0987654321', 'Quốc Oai, Hà Nội', 'Giao hàng cẩn thận'),
(4447, 3, 'Nguyễn Văn Cảnh', '0987654321', 'Quốc Oai, Hà Nội', ''),
(4482, 3, 'Nguyễn Văn Cảnh', '0987654321', 'Quốc Oai, Hà Nội', 'Giao hàng cẩn thận'),
(4509, 3, 'Nguyễn Văn Cảnh', '0987654321', 'Quốc Oai, Hà Nội', ''),
(6976, 3, 'Nguyễn Văn Cảnh', '0987654321', 'Quốc Oai, Hà Nội', ''),
(7250, 3, 'Nguyễn Văn Cảnh', '0987654321', 'Quốc Oai, Hà Nội', ''),
(7293, 1, 'Hoang Giang', '0123456789', 'Thanh Xuân, Hà Nội', 'Đơn hàng mua trực tiếp'),
(8909, 3, 'Nguyễn Văn Cảnh', '0987654321', 'Quốc Oai, Hà Nội', ''),
(9780, 3, 'Nguyễn Văn Cảnh', '0987654321', 'Yên Nghĩa, Hà Đông', 'Gói hàng đẹp giúp tôi');
...
INSERT INTO `evaluate` (`evaluate_id`, `account_id`, `product_id`, `order_code`, `account_name`, `evaluate_rate`, `evaluate_content`, `evaluate_date`, `evaluate_status`) VALUES
(2, 3, 4, '8156', 'Nguyễn Văn C', 5, 'Sản phẩm đẹp lắm', '2025-03-14 00:31:10', 1),
(3, 3, 11, '6952', 'Nguyễn Văn C', 5, 'Mùi thơm dễ chịu', '2025-03-14 02:15:27', 1),
(4, 3, 12, '6952', 'Nguyễn Văn C', 5, 'Mùi hương rất dễ chịu', '2025-03-14 02:15:02', 1);
...
(1, 3, 'Chủ 1', 'Xưởng A', '0123456789', 'Nhập đợt 1', '7733', '2025-02-13', 4200000, 0);
...
(1, '2025-01-14', 4, '14561000', 6),
(2, '2025-02-01', 2, '668000', 2),
(3, '2025-03-14', 1, '3150000', 1);
...
(1, 6952, '2025-01-14 00:14:20', 3, 6976, 5841000, 1, 5),
(2, 7813, '2025-01-14 00:15:17', 1, 465, 4147000, 5, 3),
(3, 7339, '2025-01-14 00:28:52', 3, 2693, 2286500, 1, 4),
(4, 8179, '2025-01-14 00:41:42', 3, 629, 142500, 1, 0),
(5, 2208, '2025-01-14 00:54:26', 3, 8909, 2286500, 1, 4),
(6, 8156, '2025-02-01 22:24:35', 3, 1914, 513000, 1, 5),
(7, 3367, '2025-02-01 22:25:24', 1, 7293, 155000, 5, 3),
(8, 7046, '2025-02-11 22:40:52', 3, 9780, 1605500, 1, 0),
(9, 2001, '2025-02-12 13:23:36', 3, 1393, 3015000, 1, 0),
(10, 5921, '2025-02-12 18:23:00', 3, 4482, 155000, 1, 0),
(11, 1240, '2025-02-13 16:27:01', 3, 4447, 3015000, 1, 0),
(12, 4637, '2025-03-14 02:19:16', 3, 4509, 3150000, 1, 5);
...
(1, 6952, 11, 1, 2990000, 10),
(2, 6952, 12, 1, 3500000, 10),
(3, 7813, 13, 1, 1690000, 5),
(4, 7813, 11, 1, 2990000, 15),
(5, 7339, 10, 1, 2690000, 15),
(6, 8179, 2, 1, 150000, 5),
(7, 2208, 10, 1, 2690000, 15),
(8, 8156, 4, 1, 513000, 0),
(9, 3367, 14, 1, 155000, 0),
(10, 7046, 13, 1, 1690000, 5),
(11, 2001, 9, 1, 3350000, 10),
(12, 5921, 14, 1, 155000, 0),
(13, 1240, 9, 1, 3350000, 10),
(14, 4637, 12, 1, 3500000, 10);
...
--
ALTER TABLE `inventory_detail`
  MODIFY `inventory_detail_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
