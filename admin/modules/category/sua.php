                    ...
                    <div class="card-content">
                        <form method="POST" action="modules/category/xuly.php?category_id=<?php echo $_GET['category_id']; ?>" enctype="multipart/form-data">
                            <div class="input-item form-group">
                                ...
                                <input type="text" name="category_name" class="form-control" value="<?php echo $item['category_name']; ?>" required>
                            </div>
                            <div class="input-item form-group">
                                <label for="category_description">Mô tả danh mục</label>
                                <textarea name="category_description" class="form-control" required><?php echo $item['category_description']; ?></textarea>
                            </div>
                            <div class="input-item form-group">
                                <label for="category_image">Hình ảnh</label>
                                <input type="file" id="category_image" name="category_image" class="form-control">
                            </div>
                            <button type="submit" name="category_edit" class="btn btn-primary"><i class="ti-file btn-icon-prepend"></i> Cập nhật</button>
                        </form>
                    </div>
                </div>
            </div>
