                    ...
                    <form method="POST" action="modules/account/xuly.php?account_id=<?php echo $_GET['account_id'] ?>">
                        ...
                        ?>
                            ...
                            <div class="input-item form-group">
                                ...
                                <select name="account_type" id="account_type" class="form-control text-dark bg-white">
                            ...
                            <div class="input-item form-group">
                                ...
                                <select name="account_status" id="account_status" class="form-control text-dark bg-white">
