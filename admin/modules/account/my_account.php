                    ...
                    ?>
                        <form method="POST" action="modules/account/xuly.php?account_id=<?php echo $_SESSION['account_id_admin'] ?>">
                            <div class="input-item form-group">
                                <label for="title" class="d-block">Họ và tên</label>
                            ...
                            <div class="input-item form-group">
                                ...
                                <input class="form-control" name="account_address" type="text" value="<?php echo $row['customer_address']; ?>">
                            </div>
                            <div class="input-item form-group">
                                ...
                                <div class="gender-details">
                                    <input type="radio" class="cursor-pointer" name="customer_gender" value="0" id="dot-1" <?php if ($row['customer_gender'] == 0) {
                                                                                                                                echo "checked";
                                                                                                                            } ?>> <label class="info__title cursor-pointer" for="dot-1">Khác</label>
