                        ...
                        <div class="receipt">
                            ...
                            <div class="receipt__info">
                                <table>
                                    <tr>
                                        <td>
                                            <p class="receipt__info--name">Người nhập hàng: <input class="receipt__info--input" name="staf_name" type="text" placeholder="Tên người nhập" required></p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="receipt__info--note">Ghi chú: <input class="receipt__info--input" name="inventory_note" type="text" placeholder="Lý do nhập hàng" required></p>
                                        </td>
                                        <td>
                ...
                <div class="card-content">
                    <form action="modules/inventory/xuly.php" method="POST">
                        <div class="input-item form-group">
                            <label for="productid" class="d-block">Chọn sản phẩm cần nhập</label>
