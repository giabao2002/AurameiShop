                    ...
                    <div class="receipt">
                        ...
                        ?>
                            <div class="receipt__header text-center">
                                <h3 class="receipt__title">Phiếu nhập hàng</h3>
                                <p>Mã phiếu: <?php echo $inventory['inventory_code'] ?></p>
                                <p class="receipt__date">Ngày nhập: <?php echo date('d/m/Y', strtotime($inventory['inventory_date'])); ?></p>
                            </div>
                            <div class="receipt__info">
                                <table>
                                    <tr>
                                        <td>
                                            <p class="receipt__info--name">Người nhập hàng: <input class="receipt__info--input" name="staf_name" value="<?php echo $inventory['staf_name'] ?>" type="text" placeholder="tên người nhập" required></p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="receipt__info--note">Ghi chú: <input class="receipt__info--input" name="inventory_note" value="<?php echo $inventory['inventory_note'] ?>" type="text" placeholder="Lý do nhập hàng" required></p>
                                        </td>
                                        <td>
