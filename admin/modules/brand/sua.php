                    ...
                    <form method="POST" action="modules/brand/xuly.php?brand_id=<?php echo $_GET['brand_id']; ?>" enctype="multipart/form-data">
                        ...
                        ?>
                            <div class="input-item form-group">
                                <label for="brand_name" class="d-block">Tên thương hiệu</label>
                                <input type="text" name="brand_name" class="form-control" value="<?php echo $item['brand_name']; ?>" required>
                            </div>
                            <button type="submit" name="brand_edit" class="btn btn-primary btn-icon-text">
                                <i class="ti-file btn-icon-prepend"></i>Cập nhật
                            </button>
                        <?php
                        }
                        ?>
