...
<div class="row" style="margin-bottom: 10px;">
    <div class="col d-flex" style="justify-content: space-between; align-items: flex-end;">
        <h3> Chi tiết đơn tại cửa hàng</h3>
            ...
            <div class="card-body">
                <div class="card-content">
                    <div class="checkout">
                        ...
                        <a href="modules/order/indonhang.php?order_code=<?php echo $order_code ?>" target="_blank" class="btn btn-outline-dark btn-fw"><i class="icon-printer"></i> In hóa đơn</a>
                    </div>
                </div>
            </div>
        </div>
