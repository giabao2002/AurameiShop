...
<div class="row">
    <div class="col">
        <div class="header__list d-flex space-between align-center">
            <h3>Danh sách đơn hàng trực tuyến</h3>
                    ...
                    <div class="dropdown dropdown__item">
                        <button class="btn btn-outline-dark dropdown-toggle" type="button" id="dropdownMenuSizeButton2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            if (isset($_GET['order_status']) && $_GET['order_status'] == 0) {
                                ...
                                echo "Đã giao hàng";
                            } elseif (isset($_GET['order_status']) && $_GET['order_status'] == 4) {
                                echo "Đơn hàng hoàn trả";
                            } elseif (isset($_GET['order_status']) && $_GET['order_status'] == 5) {
                                echo "Đã hoàn thành";
                            } elseif (isset($_GET['order_status']) && $_GET['order_status'] == -1) {
                                echo "Đơn đã hủy";
                            } else {
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuSizeButton2">
                            ...
                            <a class="dropdown-item" href="index.php?action=order&query=order_list&order_status=3">Đã giao hàng</a>
                            <a class="dropdown-item" href="index.php?action=order&query=order_list&order_status=4">Đơn hàng hoàn trả</a>
                            <a class="dropdown-item" href="index.php?action=order&query=order_list&order_status=5">Đã hoàn thành</a>
                            <a class="dropdown-item" href="index.php?action=order&query=order_list&order_status=-1">Đơn đã hủy</a>
                        </div>
                    </div>
                </div>
