                        ...
                        <div class="d-flex algin-center space-between">
                            ...
                            ?>
                                <div class="order__detail--action">
                                    ...
                                    ?>
                                    <a href="modules/order/indonhang.php?order_code=<?php echo $order_code ?>" target="_blank" class="btn btn-outline-dark btn-fw mg-l-16"><i class="icon-printer"></i> In hóa đơn</a>
                                </div>

                                <div class="order_status">Trạng thái đơn: <span class="col-span"><?php echo format_order_status($status['order_status']); ?></span></div>
                            <?php
                            }
                            ?>
                        </div>
