...
$pdf->Ln(10);
$pdf->Cell(0, 0, 'HÓA ĐƠN TẠI CỬA HÀNG', 0, 0, 'C');
$pdf->Ln(20);
...
$pdf->Write(10, "Họ và tên: " . $row_info['delivery_name']);
$pdf->Ln(10);

$pdf->Write(10, "Số điện thoại: " . $row_info['delivery_phone']);
$pdf->Ln(10);

$pdf->Write(10, "Địa chỉ: " . $row_info['delivery_address']);
$pdf->Ln(20);
...
$pdf->Write(10, 'Mỹ phẩm AuraMei cảm ơn bạn đã tin dùng.');
$pdf->Ln(10);
