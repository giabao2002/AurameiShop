    ...
    <div class="col">
        <div class="header__list d-flex space-between align-center">
            ...
            <div class="action_group">
                ...
                <a href="?action=inventory&query=inventory_list" class="button button-dark">Tạo phiếu</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="main-pane-top d-flex justify-center align-center">
                    <div class="input__search p-relative">
                        <form class="search-form" action="?action=product&query=product_search" method="POST">
                            ...
                            <input type="search" class="form-control" name="product_search" placeholder="Tìm kiếm theo..." title="Search here">
                        </form>
                    </div>
                </div>
