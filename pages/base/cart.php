        ...
        ?>
            ...
            <div class="cart__footer w-100 h-100">
                ...
                if (isset($_SESSION['account_email'])) {
                    if ($validate == true) {
                ?>
                        <a href="index.php?page=checkout" class="btn cart__btn btn__solid text-center">Thanh toán</a>
                    <?php } else {
                    ?>
                        <button class="btn cart__btn btn__solid text-center opacity-50" onclick="showErrorMessage();">Thanh toán</button>
                    <?php
                    }
                } else {
                    ?>
                    <a href="index.php?page=login"><button class="btn cart__btn btn__outline">Đăng nhập</button></a>
                <?php
                }
                ?>
