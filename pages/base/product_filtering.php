        ...
        <div class="row">
            <div class="col">
                <div class="product__title">
                    <h2 class="h3">Các sản phẩm đã mua</h2>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="col" style="--w: 6; --w-md: 3">
                        <div class="product__card d-flex flex-column">
                            <div class="product__image p-relative">
                                ...
                                ?>
                                    <span class="product__sal h5 p-absolute"> - <?php echo $row_relatedProc['product_sale'] ?>%</span>
                                <?php
                                }
                                ?>
                            </div>
            ...
            <?php
                ...
                echo "<p>Không có sản phẩm nào được đề xuất.</p>";
            }
            ?>
        </div>
