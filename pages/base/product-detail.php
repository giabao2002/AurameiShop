                    ...
                    <div class="col" style="--w-md: 6">
                        <div class="product-detail__info">
                            <form method="POST" action="pages/handle/addtocart.php?product_id=<?php echo $row_product_detail['product_id'] ?>">
                                ...
                                <?php } else { ?>
                                    <a href="#" class="btn product-detail__buynow w-100 text-center">Liên hệ</a>
                                <?php } ?>
                    ...
                    <div class="evaluate__content">
                        ...
                        ?>
                            <div class="comment-item d-flex">
                                <div class="f-cmuser"><abbr title="User"><?php echo substr($evaluate['account_name'], 0, 1) ?></abbr></div>
                                <div class="cmuser-content d-flex flex-column">
                                    ...
                                    <div class="customer__name">
                                        ...
                                        <span class="evaluate_date">
                                            <?php echo date('d/m/Y', strtotime($evaluate['evaluate_date'])); ?>
                                        </span>
                                    </div>
